...
| [**giant-proxy**](https://github.com/bearded-giant/gproxy) | Rust | A Proxyman-like remote mapping proxy app (Mac) as well as CLI (Linux/Mac).  Create profiles and rules to map remote for local or cxross env testing/use. |
